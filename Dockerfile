...
FROM reg.ylb.im/voicebook/ruby:$RUBY_VERSION-slim AS base
...
RUN apt-get update -qq && \
    apt-get install --no-install-recommends -y curl default-mysql-client ffmpeg libjemalloc2 poppler-utils && \
