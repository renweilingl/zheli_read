# frozen_string_literal: true
  class Admin::BooksController < ApplicationController
    ...
    before_action :set_book, only: [:show, :edit, :update, :destroy, :publish, :offline, :toggle_status, :toggle_lock]
    ...
    def upload_cover
      ...
      # TODO: 上传到 OSS 或本地存储
      url = "/uploads/books/cover/#{SecureRandom.uuid}#{File.extname(file.original_filename)}"
